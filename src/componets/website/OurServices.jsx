    ...
    <div className="py-[2rem] sm:py-[5rem] bg-backgroundcolor text-primarytextcolor">
      ...
      >
        ...
        <h2 data-aos="fade-up" className="heading-2 max-w-[50rem]">
          ...
          <br /> Partnership That Lasts.
        </h2>
        <p data-aos="fade-up" className="desc max-w-[50rem]">
          At SARAL, we’re not just here to build software—we’re here to help you
          move faster, work smarter, and grow with confidence. From next‑gen AI
          tools to powerful cloud infrastructure and user‑first design, we
          deliver technology that drives results.
        </p>
            ...
            <div className="keen-slider__slide  p-4 h-full ">
              ...
              >
                <div className="group hover:scale-105 h-full   rounded-lg bg-backgro-gradient p-[1px] transition-all  duration-500">
                  <div className="rounded-lg bg-white min-h-[22rem] sm:min-h-[23.25rem] hover:bg-custom-gradient p-5 flex flex-col justify-between items-start text-start h-full gap-4">
