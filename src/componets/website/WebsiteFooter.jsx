          ...
          <div className="flex justify-center gap-5 w-full">
            <div className="flex gap-5 items-center mt-5">
              ...
              <Link to={companyDetails.instagram}>
                <FaInstagram className="text-xl text-gray-800 hover:text-primary transition-all duration-300" />
              </Link>
              <Link to={companyDetails.linkedin}>
                <BsLinkedin className="text-xl text-gray-800 hover:text-primary transition-all duration-300" />
              </Link>
              <Link to={companyDetails.x}>
                <FaXTwitter className="text-xl text-gray-800 hover:text-primary transition-all duration-300" />
              </Link>
              {/* <Link>
