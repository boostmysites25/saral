...
import {
  ...
  landingPageServicesDetails,
  webDevelopmentServices,
} from "../../constant";

const LandingServicesTwo = ({ page }) => {
  const services =
    page === "web-development"
      ? webDevelopmentServices
      : appDevelopmentServices;

  const landingServiceDetails = landingPageServicesDetails.find(
...
export default LandingServicesTwo;
