...
const Thankyou = () => {
  return (
    <div className="min-h-screen flex flex-col justify-between bg-primary/20">
      <div className="py-4 top-0 w-full bg-white/70 backdrop-blur-md z-50 text-black">
            ...
            <div className="flex justify-center gap-5 w-full">
              <div className="flex gap-5 items-center mt-5">
                ...
                <Link to={companyDetails.instagram}>
                  <FaInstagram className="text-xl text-gray-900 hover:text-primary transition-all duration-300" />
                </Link>
                <Link to={companyDetails.linkedin}>
                  <BsLinkedin className="text-xl text-gray-900 hover:text-primary transition-all duration-300" />
                </Link>
                <Link to={companyDetails.x}>
                  <FaXTwitter className="text-xl text-gray-900 hover:text-primary transition-all duration-300" />
                </Link>
                {/* <Link>
