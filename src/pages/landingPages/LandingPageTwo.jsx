...
import LandingServicesTwo from "../../componets/landingPages/LandingServicesTwo";
import PortfolioTwo from "../../componets/landingPages/PortfolioTwo";
import SEOHead from "../../components/SEO/SEOHead";
import { landingPageSeoData } from "../../data/seoData";

export const LandingPageTwo = ({ page }) => {
  const pageDetails = landingPageContent.find(
    (entry) => entry.link.toLowerCase() === page.toLowerCase()
  );
  ...
  const onSubmit = async (data) => {
    ...
    var payload = {
      ...
      subject: "You have a new message from SARAL",
      body: emailBody,
    };
  ...
  return (
    <>
      <SEOHead {...landingPageSeoData[page]} />
      ...
      <LandingServicesTwo page={page} />
      <WhyChooseUs />

      <UnlockEfficiency />
      {page === "blockchain-development" && <PortfolioTwo />}
      <Testimonials />
      <Credibility />
      <Faqs />
      <div
        ...
        <div className="wrapper">
          <div className="h-full grid md:grid-cols-2 gap-10 py-5">
            <div className="flex flex-col gap-4">
              ...
              <p className="desc">
                Get in touch with <span className="font-semibold">SARAL </span>
