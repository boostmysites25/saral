...
const Portfolio = () => {
  ...
  return (
    <>
      <SEOHead {...seoData.portfolio} />
      <div className="">
        <div className="wrapper pt-[9rem] pb-[4rem] paddingbottom ">
        <h2 className="heading-1 text-center mb-6">Company Portfolio</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {getCurrentPortfolio().map((project) => (
            ...
            >
              ...
              />
              <div className="p-4">
                <h3 className="small-heading text-black  mb-2 ">
                  {project.title}
                </h3>
                {project.link ? (
                  <a
