          ...
          <div className="mx-auto max-w-7xl">
            <div className="grid items-center gap-8 lg:grid-cols-2">
              ...
              <div className="">
                ...
                >
                  Driving AI-Fueled Innovation for the Future-Ready World
                </h1>
                <p
                  data-aos="fade-up"
                  className="text-lg text-start leading-relaxed text-gray-600"
                >
                  At SARAL, we breathe algorithms, drink data, and think design.
                  Born at the crossroads of innovation and simplicity, we
                  specialize in crafting transformative IT solutions powered by
                  Artificial Intelligence. Our expertise lies in addressing
                  unique challenges and delivering tailored AI-driven services,
                  ensuring that businesses worldwide thrive in a
                  technology-first era.
                  <br />
                  <br />
                  We are a passionate team of developers, data scientists, and
                  innovators obsessed with creating tech that’s not only
                  smart—but meaningful. Whether it’s crafting intelligent AI
                  systems, building decentralized platforms, or launching
                  scalable SaaS products—we design with purpose and build with
                  heart, solutions that move fast, scale seamlessly, and feel
                  human.
                </p>
              </div>
              ...
              {whyChooseUsContent.map((feature, index) => (
                ...
                >
                  <div className="flex items-center gap-4 mb-4">
                    <div className="flex items-center justify-center w-12 h-12 rounded-full bg-blue-100 text-primary group-hover:bg-secondary group-hover:text-white transition-colors duration-300">
                      {feature.img}
                    </div>
                  </div>
