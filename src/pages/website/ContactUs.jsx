    ...
    <>
      ...
      <div className="wrapper py-[5rem] grid lg:grid-cols-[45%_auto] gap-7">
        ...
        >
          ...
          <p className="desc">
            Let SARAL be the catalyst for your digital transformation. Together,
            ...
            <div className="rounded-lg h-full bg-primarytextcolor p-4">
              ...
              >
                <div className="flex flex-col gap-1">
                  <input
                    type="text"
                    className="border-white p-2 rounded-md border outline-none bg-transparent"
                    placeholder="Name"
        ...
        <div className="flex lg:col-span-2 gap-5 items-center text-primarytextcolor mb-1 mx-auto">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              <FaInstagram className="text-xl text-primarytextcolor group-hover:text-primary transition-all duration-300" />
            </Link>
            <Link
